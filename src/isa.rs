...
pub const OPCODE_MADD: u32 = 0b1000011; // R4-type: fused multiply-add
pub const OPCODE_MSUB: u32 = 0b1000111; // R4-type: fused multiply-sub
pub const OPCODE_NMSUB: u32 = 0b1001011; // R4-type: negated fused multiply-sub
pub const OPCODE_NMADD: u32 = 0b1001111; // R4-type: negated fused multiply-add
...
pub const OPCODE_OP_FP: u32 = 0b1010011; // R-type: FP arithmetic/convert
